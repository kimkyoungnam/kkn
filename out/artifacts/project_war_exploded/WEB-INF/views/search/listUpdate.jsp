        ...
        <section class="content container-fluid">
            <div class="col-lg-12">
                <div class="box box-primary">
                    ...
                    <form role="form" method="post" action="/search/listUpdateDo">
                        <div class="box-body">
                            ...
                            <input type="hidden" name="currentPage" value="${searchOption.currentPage}">
                            <input type="hidden" name="pageSize" value="${searchOption.pageSize}">
                            <input type="hidden" name="searchType" value="${searchOption.searchType}">
                            <input type="hidden" name="keyword" value="${searchOption.keyword}">
                        </div>
                    </form>
...
<script>
    $(document).ready(function () {
        ...
        $(".listBtn").on("click", function () {
            self.location = "/search/listAll?currentPage=${searchOption.currentPage}"
